...
ADMIN_COMMANDS = [
    BotCommand(command="skip", description="Пропустити трек"),
    ...
    BotCommand(command="close", description="Закрити етер до замовлень"),
    BotCommand(command="open", description="Відкрити етер до замовлень"),
    ...
    BotCommand(command="ban", description="Заблокувати користувача (+ причина)"),
